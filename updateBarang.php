    ...
    <div class="container">
        <div class="register">
            ...
            <form action="prosesUpdate.php" method="post" enctype="multipart/form-data" class="firstForm">
                ...
                <div class="details">
                    <label for="gambar_barang"><p>Gambar Barang</p></label>
                    <div class="gambar-container">
                        <?php
                        $gambarPath = "upload/" . $row['gambar_barang'];
